__loadLesson({
  ...
  "concept_cards": [
    ...
    {
      "id": "PW-01",
      "visual_img": "img/sci_wave_vs_medium_v1.png",
      "term": "파동과 매질",
      "definition": "한곳에서 생긴 진동이 주위로 퍼져 나가는 현상이 파동이다. 파동을 전달하는 물질을 매질이라 하며, 매질은 제자리에서 진동할 뿐 파동과 함께 이동하지 않는다.",
      "easy_explanation": "잔잔한 물에 돌을 던지면 물결이 둥글게 퍼지지? 그게 파동이야. 이때 물(매질)은 제자리에서 위아래로만 출렁일(진동할) 뿐, 물 자체가 가장자리로 흘러가는 게 아니야. 물 위 나뭇잎이 제자리에서 까딱까딱하는 것만 봐도 알 수 있어. 파동이 전달하는 건 물질이 아니라 에너지와 정보야. 물결파의 매질은 물, 소리는 공기, 지진파는 땅이야.",
    ...
    {
      "id": "PW-04",
      "visual_img": "img/sci_sound_medium_v1.png",
      "term": "소리의 발생과 전달",
      "definition": "소리(음파)는 물체의 진동으로 발생하며, 기체·액체·고체 같은 매질을 통해 전달된다. 매질이 없는 진공에서는 전달되지 않는다.",
      "easy_explanation": "스피커 앞에 손을 대면 떨림이 느껴지지? 물체가 떨리면 주변 공기가 떨리고(매질의 진동), 그 떨림이 귀까지 와서 소리로 들려. 공기뿐 아니라 물·금속 같은 액체·고체(매질)로도 전달돼. 하지만 공기가 없는 우주(진공)에서는 소리가 전달되지 않아.",
  ...
  "exam_prep": [
    ...
    },
    {
      ...
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
          "prompt_modifier": "조건(설명으로 '옳지 않은' 것 1개)을 먼저 확인"
        },
        "time_pressure": {
          "active": true,
          "seconds": 55
    ...
    },
    {
      ...
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
          "prompt_modifier": "조건(연결이 '옳지 않은' 것 1개)을 먼저 확인"
        },
        "time_pressure": {
          "active": true,
          "seconds": 55
    ...
    },
    {
      ...
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
          "prompt_modifier": "조건(까닭으로 '옳은' 것 1개)을 먼저 확인"
        },
        "time_pressure": {
          "active": true,
          "seconds": 50
    ...
    },
    {
      "id": "L3-W18",
      "type": "choice",
      "instruction": "물결파의 진행과 매질의 운동.",
      "question": "그림은 오른쪽으로 진행하는 물결파의 모습이다(실선=지금, 점선=잠시 후). P점이 다음 순간 움직이는 방향으로 옳은 것은?",
      "visual_img": "img/sci_pw_q18.png",
      "options": [
        "위(↑)로 올라간다",
        "아래(↓)로 내려간다",
        "파동을 따라 오른쪽으로 이동한다",
      ...
      "explanation": "💡 매질은 제자리에서 위아래로만 진동해.\n📖 P 왼쪽의 마루가 다음 순간 P 자리로 와서 P는 위로 올라가(점선).\n🔑 '파동과 함께 오른쪽으로'는 대표 함정 — 매질은 옆으로 안 가.",
      "wrong_explanations": {
        "1": "점선을 보면 P는 위로 올라가(아래 아님).",
        "2": "매질은 옆으로 이동하지 않아 — 제자리 위아래 진동만.",
        "3": "정지가 아니라 위아래로 움직여."
      },
      "hint": "매질은 위아래로만. 옆으로 가는 건 파동(에너지)."
    },
    {
      "id": "L3-W19",
      "type": "choice",
      ...
      "explanation": "💡 매질은 제자리에서 위아래로만 진동해.\n📖 P 왼쪽의 골이 다음 순간 P 자리로 와서 P는 아래로 내려가(점선).\n🔑 매질은 파동을 따라 옆으로 가지 않아.",
      "wrong_explanations": {
        "1": "점선을 보면 P는 아래로 내려가(위 아님).",
        "2": "매질은 옆으로 이동하지 않아 — 제자리 진동만.",
        "3": "정지가 아니라 위아래로 움직여."
      },
      "hint": "P 왼쪽이 골이면 다음 순간 내려가."
    },
    {
      "id": "L3-W20",
      "type": "choice",
      "instruction": "시간-위치 그래프에서 진동수 읽기.",
      "question": "그림은 시간에 따른 매질의 진동이다. 이 파동의 진동수로 옳은 것은?",
      "sentence": "가로축은 시간(초), 세로축은 위치이다.",
      "visual_img": "img/sci_pw_q20.png",
      "options": [
        "4 Hz",
        "2 Hz",
        "0.5 Hz",
      ...
      "explanation": "💡 0.5초 동안 2번 진동 → 1초엔 4번 → 4 Hz.\n📖 진동수 = 진동 횟수 ÷ 시간 = 2 ÷ 0.5.\n🔑 주기(한 번 진동하는 데 걸리는 시간)=0.25초=1÷4.",
      "wrong_explanations": {
        "1": "0.5초에 2번이니 1초엔 4번이야.",
        "2": "0.5 Hz는 2초에 1번일 때.",
        "3": "8 Hz는 1초에 8번일 때."
      },
      "hint": "1초 기준으로 환산: 0.5초에 2번이면?"
    },
    {
      "id": "L3-W21",
      "type": "choice",
      "instruction": "시간-위치 그래프에서 주기·진동수 읽기.",
      "question": "그림은 시간에 따른 매질의 진동이다. 이 파동의 주기(매질이 한 번 진동하는 데 걸리는 시간)와 진동수로 옳은 것은?",
      "sentence": "가로축은 시간(초), 세로축은 위치이다.",
      "visual_img": "img/sci_pw_q21.png",
      "options": [
        "주기 0.5초, 진동수 2 Hz",
        "주기 2초, 진동수 0.5 Hz",
        "주기 1초, 진동수 1 Hz",
      ...
      "explanation": "💡 한 번 진동(출렁임)하는 데 0.5초 → 주기 0.5초.\n📖 진동수 = 1 ÷ 주기 = 1 ÷ 0.5 = 2 Hz.\n🔑 1초 동안 2번 진동.",
      "wrong_explanations": {
        "1": "한 번 진동에 0.5초야(2초 아님).",
        "2": "1초에 2번이니 1Hz가 아니라 2Hz.",
        "3": "진동수=1÷0.5=2Hz."
      },
      "hint": "한 번 출렁이는 시간=주기, 그 역수가 진동수."
    },
    {
      "id": "L3-W22",
      "type": "choice",
      "instruction": "세 파형의 세기 비교.",
      "question": "그림은 세 소리 (가),(나),(다)의 파형이다. 가장 큰 소리는?",
      "sentence": "세 그래프의 가로축(시간) 눈금은 같다.",
      "visual_svg": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 360 185\" width=\"360\" height=\"185\"><line x1=\"70\" y1=\"40\" x2=\"330\" y2=\"40\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,40.0 L 73.0,34.2 L 76.0,28.6 L 79.0,23.1 L 82.0,18.1 L 85.0,13.5 L 88.0,9.4 L 91.0,6.0 L 94.0,3.3 L 97.0,1.4 L 100.0,0.3 L 103.0,0.0 L 106.0,0.6 L 109.0,2.0 L 112.0,4.1 L 115.0,7.1 L 118.0,10.7 L 121.0,15.0 L 124.0,19.7 L 127.0,24.9 L 130.0,30.4 L 133.0,36.1 L 136.0,41.9 L 139.0,47.7 L 142.0,53.3 L 145.0,58.6 L 148.0,63.5 L 151.0,67.9 L 154.0,71.8 L 157.0,75.0 L 160.0,77.4 L 163.0,79.1 L 166.0,79.9 L 169.0,79.9 L 172.0,79.1 L 175.0,77.4 L 178.0,75.0 L 181.0,71.8 L 184.0,67.9 L 187.0,63.5 L 190.0,58.6 L 193.0,53.3 L 196.0,47.7 L 199.0,41.9 L 202.0,36.1 L 205.0,30.4 L 208.0,24.9 L 211.0,19.7 L 214.0,15.0 L 217.0,10.7 L 220.0,7.1 L 223.0,4.1 L 226.0,2.0 L 229.0,0.6 L 232.0,0.0 L 235.0,0.3 L 238.0,1.4 L 241.0,3.3 L 244.0,6.0 L 247.0,9.4 L 250.0,13.5 L 253.0,18.1 L 256.0,23.1 L 259.0,28.6 L 262.0,34.2 L 265.0,40.0 L 268.0,45.8 L 271.0,51.4 L 274.0,56.9 L 277.0,61.9 L 280.0,66.5 L 283.0,70.6 L 286.0,74.0 L 289.0,76.7 L 292.0,78.6 L 295.0,79.7 L 298.0,80.0 L 301.0,79.4 L 304.0,78.0 L 307.0,75.9 L 310.0,72.9 L 313.0,69.3 L 316.0,65.0 L 319.0,60.3 L 322.0,55.1 L 325.0,49.6 L 328.0,43.9\" fill=\"none\" stroke=\"#1565C0\" stroke-width=\"2.3\"/><text x=\"46\" y=\"44\" font-size=\"13\" fill=\"#1565C0\" font-weight=\"bold\" text-anchor=\"middle\">(가)</text><line x1=\"70\" y1=\"90\" x2=\"330\" y2=\"90\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,90.0 L 73.0,87.1 L 76.0,84.3 L 79.0,81.6 L 82.0,79.0 L 85.0,76.7 L 88.0,74.7 L 91.0,73.0 L 94.0,71.7 L 97.0,70.7 L 100.0,70.1 L 103.0,70.0 L 106.0,70.3 L 109.0,71.0 L 112.0,72.1 L 115.0,73.5 L 118.0,75.4 L 121.0,77.5 L 124.0,79.9 L 127.0,82.5 L 130.0,85.2 L 133.0,88.1 L 136.0,91.0 L 139.0,93.8 L 142.0,96.6 L 145.0,99.3 L 148.0,101.8 L 151.0,104.0 L 154.0,105.9 L 157.0,107.5 L 160.0,108.7 L 163.0,109.5 L 166.0,109.9 L 169.0,109.9 L 172.0,109.5 L 175.0,108.7 L 178.0,107.5 L 181.0,105.9 L 184.0,104.0 L 187.0,101.8 L 190.0,99.3 L 193.0,96.6 L 196.0,93.8 L 199.0,91.0 L 202.0,88.1 L 205.0,85.2 L 208.0,82.5 L 211.0,79.9 L 214.0,77.5 L 217.0,75.4 L 220.0,73.5 L 223.0,72.1 L 226.0,71.0 L 229.0,70.3 L 232.0,70.0 L 235.0,70.1 L 238.0,70.7 L 241.0,71.7 L 244.0,73.0 L 247.0,74.7 L 250.0,76.7 L 253.0,79.0 L 256.0,81.6 L 259.0,84.3 L 262.0,87.1 L 265.0,90.0 L 268.0,92.9 L 271.0,95.7 L 274.0,98.4 L 277.0,101.0 L 280.0,103.3 L 283.0,105.3 L 286.0,107.0 L 289.0,108.3 L 292.0,109.3 L 295.0,109.9 L 298.0,110.0 L 301.0,109.7 L 304.0,109.0 L 307.0,107.9 L 310.0,106.5 L 313.0,104.6 L 316.0,102.5 L 319.0,100.1 L 322.0,97.5 L 325.0,94.8 L 328.0,91.9\" fill=\"none\" stroke=\"#E65100\" stroke-width=\"2.3\"/><text x=\"46\" y=\"94\" font-size=\"13\" fill=\"#E65100\" font-weight=\"bold\" text-anchor=\"middle\">(나)</text><line x1=\"70\" y1=\"140\" x2=\"330\" y2=\"140\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,140.0 L 73.0,134.3 L 76.0,129.0 L 79.0,124.7 L 82.0,121.7 L 85.0,120.1 L 88.0,120.3 L 91.0,122.1 L 94.0,125.4 L 97.0,129.9 L 100.0,135.2 L 103.0,141.0 L 106.0,146.6 L 109.0,151.8 L 112.0,155.9 L 115.0,158.7 L 118.0,159.9 L 121.0,159.5 L 124.0,157.5 L 127.0,154.0 L 130.0,149.3 L 133.0,143.8 L 136.0,138.1 L 139.0,132.5 L 142.0,127.5 L 145.0,123.5 L 148.0,121.0 L 151.0,120.0 L 154.0,120.7 L 157.0,123.0 L 160.0,126.7 L 163.0,131.6 L 166.0,137.1 L 169.0,142.9 L 172.0,148.4 L 175.0,153.3 L 178.0,157.0 L 181.0,159.3 L 184.0,160.0 L 187.0,159.0 L 190.0,156.5 L 193.0,152.5 L 196.0,147.5 L 199.0,141.9 L 202.0,136.2 L 205.0,130.7 L 208.0,126.0 L 211.0,122.5 L 214.0,120.5 L 217.0,120.1 L 220.0,121.3 L 223.0,124.1 L 226.0,128.2 L 229.0,133.4 L 232.0,139.0 L 235.0,144.8 L 238.0,150.1 L 241.0,154.6 L 244.0,157.9 L 247.0,159.7 L 250.0,159.9 L 253.0,158.3 L 256.0,155.3 L 259.0,151.0 L 262.0,145.7 L 265.0,140.0 L 268.0,134.3 L 271.0,129.0 L 274.0,124.7 L 277.0,121.7 L 280.0,120.1 L 283.0,120.3 L 286.0,122.1 L 289.0,125.4 L 292.0,129.9 L 295.0,135.2 L 298.0,141.0 L 301.0,146.6 L 304.0,151.8 L 307.0,155.9 L 310.0,158.7 L 313.0,159.9 L 316.0,159.5 L 319.0,157.5 L 322.0,154.0 L 325.0,149.3 L 328.0,143.8\" fill=\"none\" stroke=\"#2E7D32\" stroke-width=\"2.3\"/><text x=\"46\" y=\"144\" font-size=\"13\" fill=\"#2E7D32\" font-weight=\"bold\" text-anchor=\"middle\">(다)</text><text x=\"200\" y=\"178\" font-size=\"11\" fill=\"#555\" text-anchor=\"middle\">가로축: 시간 (세 그래프 시간축 같음)</text></svg>",
      "options": [
        "(가)",
        "(나)",
        "(다)",
      ...
      "explanation": "💡 소리의 세기(크기)는 진폭이 결정 — 진폭이 가장 큰 (가)가 가장 큰 소리.\n📖 (나)·(다)는 진폭이 작아.\n🔑 (다)는 촘촘할 뿐(높은 소리), 큰 소리가 아니야.",
      "wrong_explanations": {
        "1": "(나)는 진폭이 작아 더 작은 소리.",
        "2": "(다)는 진폭이 작아 — 높은 소리지 큰 소리가 아니야.",
        "3": "진폭이 달라 세기가 같지 않아."
      },
      "hint": "큰 소리=위아래로 크게(진폭)."
    },
    {
      "id": "L3-W23",
      "type": "choice",
      "instruction": "세 파형의 높낮이 비교.",
      "question": "그림은 세 소리 (가),(나),(다)의 파형이다. 가장 높은 소리는?",
      "sentence": "세 그래프의 가로축(시간) 눈금은 같다.",
      "visual_svg": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 360 185\" width=\"360\" height=\"185\"><line x1=\"70\" y1=\"40\" x2=\"330\" y2=\"40\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,40.0 L 73.0,34.2 L 76.0,28.6 L 79.0,23.1 L 82.0,18.1 L 85.0,13.5 L 88.0,9.4 L 91.0,6.0 L 94.0,3.3 L 97.0,1.4 L 100.0,0.3 L 103.0,0.0 L 106.0,0.6 L 109.0,2.0 L 112.0,4.1 L 115.0,7.1 L 118.0,10.7 L 121.0,15.0 L 124.0,19.7 L 127.0,24.9 L 130.0,30.4 L 133.0,36.1 L 136.0,41.9 L 139.0,47.7 L 142.0,53.3 L 145.0,58.6 L 148.0,63.5 L 151.0,67.9 L 154.0,71.8 L 157.0,75.0 L 160.0,77.4 L 163.0,79.1 L 166.0,79.9 L 169.0,79.9 L 172.0,79.1 L 175.0,77.4 L 178.0,75.0 L 181.0,71.8 L 184.0,67.9 L 187.0,63.5 L 190.0,58.6 L 193.0,53.3 L 196.0,47.7 L 199.0,41.9 L 202.0,36.1 L 205.0,30.4 L 208.0,24.9 L 211.0,19.7 L 214.0,15.0 L 217.0,10.7 L 220.0,7.1 L 223.0,4.1 L 226.0,2.0 L 229.0,0.6 L 232.0,0.0 L 235.0,0.3 L 238.0,1.4 L 241.0,3.3 L 244.0,6.0 L 247.0,9.4 L 250.0,13.5 L 253.0,18.1 L 256.0,23.1 L 259.0,28.6 L 262.0,34.2 L 265.0,40.0 L 268.0,45.8 L 271.0,51.4 L 274.0,56.9 L 277.0,61.9 L 280.0,66.5 L 283.0,70.6 L 286.0,74.0 L 289.0,76.7 L 292.0,78.6 L 295.0,79.7 L 298.0,80.0 L 301.0,79.4 L 304.0,78.0 L 307.0,75.9 L 310.0,72.9 L 313.0,69.3 L 316.0,65.0 L 319.0,60.3 L 322.0,55.1 L 325.0,49.6 L 328.0,43.9\" fill=\"none\" stroke=\"#1565C0\" stroke-width=\"2.3\"/><text x=\"46\" y=\"44\" font-size=\"13\" fill=\"#1565C0\" font-weight=\"bold\" text-anchor=\"middle\">(가)</text><line x1=\"70\" y1=\"90\" x2=\"330\" y2=\"90\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,90.0 L 73.0,87.1 L 76.0,84.3 L 79.0,81.6 L 82.0,79.0 L 85.0,76.7 L 88.0,74.7 L 91.0,73.0 L 94.0,71.7 L 97.0,70.7 L 100.0,70.1 L 103.0,70.0 L 106.0,70.3 L 109.0,71.0 L 112.0,72.1 L 115.0,73.5 L 118.0,75.4 L 121.0,77.5 L 124.0,79.9 L 127.0,82.5 L 130.0,85.2 L 133.0,88.1 L 136.0,91.0 L 139.0,93.8 L 142.0,96.6 L 145.0,99.3 L 148.0,101.8 L 151.0,104.0 L 154.0,105.9 L 157.0,107.5 L 160.0,108.7 L 163.0,109.5 L 166.0,109.9 L 169.0,109.9 L 172.0,109.5 L 175.0,108.7 L 178.0,107.5 L 181.0,105.9 L 184.0,104.0 L 187.0,101.8 L 190.0,99.3 L 193.0,96.6 L 196.0,93.8 L 199.0,91.0 L 202.0,88.1 L 205.0,85.2 L 208.0,82.5 L 211.0,79.9 L 214.0,77.5 L 217.0,75.4 L 220.0,73.5 L 223.0,72.1 L 226.0,71.0 L 229.0,70.3 L 232.0,70.0 L 235.0,70.1 L 238.0,70.7 L 241.0,71.7 L 244.0,73.0 L 247.0,74.7 L 250.0,76.7 L 253.0,79.0 L 256.0,81.6 L 259.0,84.3 L 262.0,87.1 L 265.0,90.0 L 268.0,92.9 L 271.0,95.7 L 274.0,98.4 L 277.0,101.0 L 280.0,103.3 L 283.0,105.3 L 286.0,107.0 L 289.0,108.3 L 292.0,109.3 L 295.0,109.9 L 298.0,110.0 L 301.0,109.7 L 304.0,109.0 L 307.0,107.9 L 310.0,106.5 L 313.0,104.6 L 316.0,102.5 L 319.0,100.1 L 322.0,97.5 L 325.0,94.8 L 328.0,91.9\" fill=\"none\" stroke=\"#E65100\" stroke-width=\"2.3\"/><text x=\"46\" y=\"94\" font-size=\"13\" fill=\"#E65100\" font-weight=\"bold\" text-anchor=\"middle\">(나)</text><line x1=\"70\" y1=\"140\" x2=\"330\" y2=\"140\" stroke=\"#bbb\" stroke-width=\"1\" stroke-dasharray=\"3 3\"/><path d=\"M 70.0,140.0 L 73.0,134.3 L 76.0,129.0 L 79.0,124.7 L 82.0,121.7 L 85.0,120.1 L 88.0,120.3 L 91.0,122.1 L 94.0,125.4 L 97.0,129.9 L 100.0,135.2 L 103.0,141.0 L 106.0,146.6 L 109.0,151.8 L 112.0,155.9 L 115.0,158.7 L 118.0,159.9 L 121.0,159.5 L 124.0,157.5 L 127.0,154.0 L 130.0,149.3 L 133.0,143.8 L 136.0,138.1 L 139.0,132.5 L 142.0,127.5 L 145.0,123.5 L 148.0,121.0 L 151.0,120.0 L 154.0,120.7 L 157.0,123.0 L 160.0,126.7 L 163.0,131.6 L 166.0,137.1 L 169.0,142.9 L 172.0,148.4 L 175.0,153.3 L 178.0,157.0 L 181.0,159.3 L 184.0,160.0 L 187.0,159.0 L 190.0,156.5 L 193.0,152.5 L 196.0,147.5 L 199.0,141.9 L 202.0,136.2 L 205.0,130.7 L 208.0,126.0 L 211.0,122.5 L 214.0,120.5 L 217.0,120.1 L 220.0,121.3 L 223.0,124.1 L 226.0,128.2 L 229.0,133.4 L 232.0,139.0 L 235.0,144.8 L 238.0,150.1 L 241.0,154.6 L 244.0,157.9 L 247.0,159.7 L 250.0,159.9 L 253.0,158.3 L 256.0,155.3 L 259.0,151.0 L 262.0,145.7 L 265.0,140.0 L 268.0,134.3 L 271.0,129.0 L 274.0,124.7 L 277.0,121.7 L 280.0,120.1 L 283.0,120.3 L 286.0,122.1 L 289.0,125.4 L 292.0,129.9 L 295.0,135.2 L 298.0,141.0 L 301.0,146.6 L 304.0,151.8 L 307.0,155.9 L 310.0,158.7 L 313.0,159.9 L 316.0,159.5 L 319.0,157.5 L 322.0,154.0 L 325.0,149.3 L 328.0,143.8\" fill=\"none\" stroke=\"#2E7D32\" stroke-width=\"2.3\"/><text x=\"46\" y=\"144\" font-size=\"13\" fill=\"#2E7D32\" font-weight=\"bold\" text-anchor=\"middle\">(다)</text><text x=\"200\" y=\"178\" font-size=\"11\" fill=\"#555\" text-anchor=\"middle\">가로축: 시간 (세 그래프 시간축 같음)</text></svg>",
      "options": [
        "(다)",
      ...
      "explanation": "💡 소리의 높낮이는 진동수가 결정 — 같은 시간에 가장 많이 진동한 (다)가 가장 높은 소리.\n📖 (가)·(나)는 진동수 같아 높낮이 같음(세기만 다름).\n🔑 높은 소리=촘촘한 파형(큰 진동수).",
      "wrong_explanations": {
        "1": "(가)는 진폭만 클 뿐 진동수는 (다)보다 작아.",
        "2": "(나)는 진동수가 작아 낮은 소리.",
        "3": "(다)가 가장 촘촘해 가장 높아."
      },
      "hint": "높은 소리=촘촘함(진동수), 진폭과 헷갈리지 마."
    },
    {
      "id": "S3-CB-01",
      "type": "choice",
      "score_group": "A",
      "question": "파동과 매질에 대한 설명으로 옳은 것만을 <보기>에서 있는 대로 고른 것은?",
      "sentence": "ㄱ. 파동이 전달될 때 매질은 제자리에서 진동하며 파동을 따라 함께 이동하지 않는다.\nㄴ. 파동이 전달될 때 이동하는 것은 에너지(와 정보)이다.\nㄷ. 물결파의 매질은 공기이다.\nㄹ. 빛은 매질이 없는 진공에서도 전달된다.",
      "options": [
        "ㄱ, ㄴ",
        "ㄱ, ㄷ",
        "ㄴ, ㄹ",
      ...
      "correct": 3,
      "wrong_explanations": {
        "0": "ㄱ·ㄴ만 옳다고 보았으나 ㄹ(빛은 진공에서도 전달)도 옳다. ㄹ을 빠뜨린 조합이다.",
        "1": "ㄷ(물결파의 매질은 공기)은 틀린 진술이다. 물결파의 매질은 물이다.",
        "2": "ㄴ·ㄹ은 옳지만 ㄱ(매질은 제자리 진동)도 옳다. ㄱ을 빠뜨린 조합이다.",
        "4": "ㄷ(물결파의 매질은 공기)이 포함되어 틀린 조합이다. ㄷ만 틀린 진술이다."
      },
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
          "prompt_modifier": "조건: <보기>를 ㄱ부터 하나씩 옳고·그름 판정 후 정확히 맞는 조합만 선택"
        },
        "time_pressure": {
          "active": true,
          "seconds": 75
      ...
      "explanation": "💡 파동은 매질이 제자리 진동만 하고 전달되는 것은 에너지(와 정보). 물결파 매질은 물, 소리는 공기.\n🔑 빛은 매질이 없는 진공에서도 전달!"
    },
    {
      "id": "S3-CB-02",
      "type": "choice",
      "score_group": "A",
      "question": "소리의 3요소와 그것을 결정하는 요인에 대한 설명으로 옳은 것만을 <보기>에서 있는 대로 고른 것은?",
      "sentence": "ㄱ. 소리의 세기(크기)는 진폭이 결정한다.\nㄴ. 소리의 높낮이는 진동수가 결정한다.\nㄷ. 음색은 진동수가 결정한다.\nㄹ. 진폭과 진동수가 같아도 파형이 다르면 음색이 다르다.",
      "options": [
        "ㄱ, ㄴ",
        "ㄱ, ㄷ",
        "ㄴ, ㄷ",
      ...
      "correct": 3,
      "wrong_explanations": {
        "0": "ㄱ·ㄴ은 옳지만 ㄹ(파형이 다르면 음색이 다르다)도 옳다. ㄹ을 빠뜨린 조합이다.",
        "1": "ㄷ(음색은 진동수가 결정)은 틀린 진술이다. 음색은 파형이 결정한다.",
        "2": "ㄷ(음색은 진동수가 결정)이 포함되어 틀린 조합이다. 음색은 파형이 결정한다.",
        "4": "ㄷ(음색은 진동수가 결정)이 포함되어 틀린 조합이다. ㄷ만 틀린 진술이다."
      },
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
      ...
      "instruction": "〈보기〉에서 옳은 것만 모두 고르기",
      "explanation": "💡 소리 3요소: 세기=진폭, 높낮이=진동수, 음색=파형.\n🔑 진폭·진동수가 같아도 파형이 다르면 음색이 다르다."
    },
    {
      "id": "S3-CB-03",
      "type": "choice",
      "score_group": "A",
      "question": "소리의 전달에 대한 설명으로 옳은 것만을 <보기>에서 있는 대로 고른 것은?",
      "sentence": "ㄱ. 소리는 매질이 없는 진공에서는 전달되지 않는다.\nㄴ. 소리는 고체에서도 잘 전달된다.\nㄷ. 소리는 물체의 진동 없이도 발생한다.\nㄹ. 소리는 물체의 진동으로 발생한다.",
      "options": [
        "ㄱ, ㄷ",
        "ㄴ, ㄷ",
        "ㄱ, ㄴ, ㄹ",
      ...
      "correct": 2,
      "wrong_explanations": {
        "0": "ㄷ(진동 없이도 발생)은 틀린 진술이다. 소리는 물체의 진동으로 발생한다. ㄴ·ㄹ을 빠뜨렸다.",
        "1": "ㄷ(진동 없이도 발생)이 포함되어 틀린 조합이다. ㄱ·ㄹ을 빠뜨렸다.",
        "3": "ㄷ(진동 없이도 발생)이 포함되어 틀린 조합이다. ㄷ만 틀린 진술이다.",
        "4": "ㄷ(진동 없이도 발생)이 포함되고 ㄱ(진공에서 전달 안 됨)을 빠뜨려 틀린 조합이다."
      },
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
      ...
      "instruction": "〈보기〉에서 옳은 것만 모두 고르기",
      "explanation": "💡 소리는 물체의 진동으로 발생하고 매질(기체·액체·고체)을 통해 전달된다.\n🔑 매질이 없는 진공에서는 전달되지 않는다."
    },
    {
      "id": "S3-MA-01",
      "type": "choice",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "ㄱ(세기=진폭)은 옳아. 옳지 않은 건 ㄴ(높낮이=진폭)·ㄹ(음색=진동수).",
        "2": "ㄷ(높낮이=진동수)은 옳아. 옳지 않은 건 ㄴ·ㄹ.",
        "3": "ㄱ·ㅁ 둘 다 옳아.",
        "4": "ㄷ(높낮이=진동수)은 옳으니 빼야 해 — 옳지 않은 건 ㄴ·ㄹ 둘뿐."
      },
      "exam_perf_variants": {
        "condition_trap": {
          "active": true,
      ...
      "explanation": "💡 세기=진폭, 높낮이=진동수, 음색=파형.\n🔑 높낮이를 진폭으로, 음색을 진동수로 착각하는 게 대표 함정.",
      "sentence": "ㄱ. 소리의 세기(크기)는 진폭이 결정한다\nㄴ. 소리의 높낮이는 진폭이 결정한다\nㄷ. 소리의 높낮이는 진동수가 결정한다\nㄹ. 음색은 진동수가 결정한다\nㅁ. 음색은 파형이 결정한다"
    }
  ],
  "lesson": "sci3"
});

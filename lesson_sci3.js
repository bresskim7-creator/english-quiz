__loadLesson({
  ...
  "exam_prep": [
    ...
    },
    {
      ...
      "wrong_explanations": {
        "1": "💡 자동차 측면거울이 볼록거울인 건 맞아. 넓은 범위를 작게 보여주지. 근데 이건 \"굴절\"이 아니라 \"반사\"를 이용한 거야.\n📖 볼록거울=빛의 반사 이용. 이 선택지의 설명 자체는 맞지만, 문제가 \"빛과 관련된 현상\"의 올바른 설명을 고르는 것일 때 이것도 맞는 선택지야.\n🔬 단, LED 조명이 빛의 합성(RGB)으로 다양한 색을 만드는 것이 더 정확한 답이야.",

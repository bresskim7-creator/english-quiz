  ...
  "exam_prep": [
    ...
    },
    {
      ...
      "wrong_explanations": {
        ...
        "2": "💡 입사각이 작으면 반사각도 작은 건 맞지만, 이건 '같다'는 법칙의 결과이지 별개의 설명이 아니야.\n📖 핵심은 '입사각 = 반사각'이라는 거야. 크든 작든 항상 같아.\n🔬 이 선택지는 부분적으로 맞지만, 반사 법칙의 정확한 설명은 아니다.",
    ...
    },
    {
      ...
      "explanation": "💡 물이 공기보다 더 촘촘해서 빛이 느려져. 빛이 느려지니까 꺾이는 정도가 더 커 보이고, 그래서 입사각 > 굴절각이야.\n📖 공기 → 물일 때 빛이 느려지므로 입사각이 굴절각보다 항상 커. 이건 물리 법칙이야.\n🔬 굴절의 정도는 두 물질의 굴절률에 따라 결정되고, 온도 같은 외부 조건에는 영향 받지 않는다.",
      "wrong_explanations": {
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
    ...
    },
    {
      ...
      "explanation": "💡 거울 앞에 서서 거울을 봐. 너는 거울에서 30cm 떨어져 있고, 거울에 비친 너도 거울 뒤 30cm에 있는 것처럼 보여.\n📖 평면거울의 상은 크기가 같고, 거울을 중심으로 대칭이야. 그래서 거리도 같아.\n🔬 평면거울의 네 가지 특징: 허상, 크기 같음, 거리 같음, 좌우반전.",
      "wrong_explanations": {
        "0": "💡 평면거울에서 상의 크기는 물체와 정확히 같아. 확대나 축소가 없어.\n📖 오목거울이나 볼록렌즈와 혼동하지 말아. 평면거울은 크기가 같다.\n🔬 평면거울은 물체의 형태를 그대로 유지하므로 크기 변화가 없다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "explanation": "💡 화장할 때 확대 거울을 쓰잖아. 가까이 대면 크고 바로 보여. 멀리 대면 어느 순간부터 거꾸로 뒤집혀 보여.\n📖 오목거울은 물체의 거리에 따라 상이 달라. 가까울 때(허상), 멀 때(실상).\n🔬 오목거울 = 화장거울. 거리에 따라 상이 변한다는 게 가장 중요한 특징이다.",
      "wrong_explanations": {
        "0": "💡 오목거울이 항상 작은 상을 만들면 왜 화장거울로 쓸까? 크게 보이잖아.\n📖 오목거울은 거리에 따라 크기가 변해. 가까우면 크고, 멀면 작아져.\n🔬 항상 작은 상을 만드는 건 볼록거울이야.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "explanation": "💡 자동차 측면거울을 봐. 뭐가 비쳐도 항상 작게 보여. 가까이 대도 작고, 멀리 대도 작아.\n📖 볼록거울은 바깥쪽이 볼록한 거울이야. 넓은 범위를 작게 보여주기 때문에 자동차 측면거울로 쓰여.\n🔬 볼록거울의 핵심: 항상 작고 바로 선 허상만 만든다.",
      "wrong_explanations": {
        "0": "💡 만약 상의 크기가 달라진다면 안전거울로 쓸 수 없을 텐데? 항상 작은 게 장점이야.\n📖 볼록거울의 특징은 거리에 관계없이 항상 같다는 거야. 그래서 안전하게 쓸 수 있어.\n🔬 볼록거울은 일정한 특성을 유지하므로 거리에 따른 예측이 가능하다.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 오목거울(화장거울)과 오목렌즈(근시안경)를 비교해봐. 다르지 않나?\n📖 오목거울은 거리에 따라 상이 변하지만, 오목렌즈는 항상 같아. 다른 거야.\n🔬 오목거울 ≠ 오목렌즈. 이건 흔한 실수다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 빨강과 초록을 섞으면 파랑이 될까? 그건 논리적이지 않아. 더 밝은색이 나가야지.\n📖 빛의 특성을 생각해봐. 섞을수록 밝아지니까 파랑 같은 다른 색이 나올 리가 없지.\n🔬 R+G≠B는 기본적인 RGB 혼합의 원리를 벗어난다.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 검은색 빛이라는 게 존재할까? 그건 모순이야. 빛이 없으면 색도 없지.\n📖 검은색은 빛을 반사하는 게 아니라 흡수하는 거야.\n🔬 검은색은 물리적으로 빛의 부재이므로 '검은색 빛'이라는 개념은 성립하지 않는다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 모니터가 물감으로 색을 만들까? 모니터는 빛을 내잖아. 스스로 빛나는 거야.\n📖 모니터는 전자 기기고 빛을 발생시켜. 물감과는 달라.\n🔬 모니터는 자체 발광 디바이스이고 물감은 반사 방식이다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "explanation": "💡 맑은 날 햇빛에 비춰지면 그림자가 선명하게 생겨. 이건 광원에서 나온 빛이 물체에 막혀서 그 뒤쪽에 그림자가 생기는 거야. 빛이 일직선으로 나아가기 때문이야.\n📖 그림자의 모양이 물체의 모양과 같은 것도 빛의 직진 때문이야. 빛이 휘어지지 않고 일직선으로 나아가니까.\n🔬 빛의 직진은 일상에서 가장 기본적인 현상이고, 그림자가 가장 명확한 증거다.",
      "wrong_explanations": {
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
    ...
    },
    {
      ...
      "explanation": "💡 어두운 방에서 아무것도 안 보여. 그런데 전등을 켜는 순간 물체가 보여. 왜? 광원에서 나온 빛이 물체에 부딪혀 반사되고, 그 반사광이 눈에 들어와야 물체를 볼 수 있기 때문이야.\n📖 물체를 보는 과정: 광원 → 빛 → 물체(반사) → 눈. 이 과정에서 빛이 꼭 필요해.\n🔬 물체가 보이려면 광원이 필수이며, 광원의 빛이 물체에서 반사되어 눈에 도달해야 한다.",
      "wrong_explanations": {
        "0": "💡 어두운 방에서 정말로 물체를 볼 수 있을까? 아무것도 안 보이잖아.\n📖 광원이 없으면 아무리 좋은 눈이라도 물체를 볼 수 없어.\n🔬 광원 없이 물체를 본다는 것은 물리적으로 불가능하다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "explanation": "💡 호수에서 낚시할 때 수면이 반짝거려. 이건 빛이 반사되고 있다는 거야. 그런데 물속도 볼 수 있어. 이건 일부 빛이 물로 들어가고 있다는 거야.\n📖 물 표면에서는 반사와 굴절이 동시에 일어나. 일부 빛은 반사되고 일부는 물로 진행(굴절)돼.\n🔬 이 현상을 '부분 반사'라고 부르며, 실제 세계에서는 거의 모든 반사와 굴절에서 일어난다.",
      "wrong_explanations": {
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 평면거울이 실상을 만들까? 아니야. 평면거울은 항상 허상만 만들어.\n📖 평면거울은 거울 뒤에 상이 생기는 허상이야. 실상이 아니야.\n🔬 평면거울은 항상 같은 특징의 상을 만들므로 실상을 만들 수 없다.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 파란 조명 아래에서 초록색 물체가 초록색으로 보일까? 초록 빛이 없잖아.\n📖 없는 빛은 반사할 수 없어. 물체의 색은 그 조명에 있는 색만 반사할 수 있어.\n🔬 조명의 색이 물체의 색에 결정적 영향을 미친다는 것이 핵심이다.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
      },
    ...
    },
    {
      ...
      "explanation": "💡 TV 화면이 어떻게 모든 색을 만들까? 빨강, 초록, 파랑 점(화소)들의 밝기를 섞어서 만드는 거야. 빛을 섞으니까 더 밝은 색이 나오고, 세 색을 모두 섞으면 흰색(가장 밝음)이 돼.\n📖 빛의 합성: 다양한 색의 빛을 섞어서 새로운 색을 만드는 현상. 이건 일상 곳곳에서 일어나고 있어.\n🔬 현대 디스플레이와 조명 기술은 모두 빛의 합성 원리에 기반한다.",
      "wrong_explanations": {
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "2": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요."
    ...
    },
    {
      ...
      "wrong_explanations": {
        "0": "💡 안경이 빛의 반사를 이용할까? 안경은 빛을 투과시켜서 굴절시키잖아.\n📖 안경은 렌즈를 사용해서 빛의 굴절을 이용해. 반사가 아니야.\n🔬 안경은 렌즈의 굴절성으로 빛의 초점을 조정하여 시력을 교정한다.",
        "1": "💡 이 선택지가 틀렸습니다.\n📖 정답이 아닙니다.\n🔬 문제를 다시 확인하세요.",
        "3": "💡 프리즘이 흡수를 이용할까? 프리즘은 백색광을 분산시키는 거야.\n📖 프리즘의 굴절에 의해 빨강, 주황, 노랑, 초록, 파랑, 남색, 보라색이 분리돼.\n🔬 프리즘은 빛의 굴절을 이용해 파장 분리(분산)를 일으킨다."
      },

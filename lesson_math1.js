__loadLesson({
  ...
  "questions": [
    ...
    },
    {
      ...
      "training_layer": "skill_focus",
      "score_group": "A",
      "instruction": "다음 중 옳은 것을 모두 고른 것은?",
      "sentence": "ㄱ. 순환소수는 모두 유리수이다.\nㄴ. 순환소수는 무한소수가 아니다.\nㄷ. 무한소수는 모두 순환소수이다.\nㄹ. 정수가 아닌 유리수 중 유한소수로 나타낼 수 없는 것은 모두 순환소수가 된다.",
      "options": [
        "ㄱ, ㄹ",
        "ㄱ, ㄴ",
        "ㄴ, ㄷ",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "💡 ㄴ은 틀려! 순환소수는 끝나지 않는 소수 = 무한소수의 한 종류야.\n📖 순환소수: 끝나지 않지만 반복 패턴이 있는 소수 → 무한소수에 포함.\n⚠️ '순환'이라는 단어에 속아 '짧다, 유한이다'라고 착각하지 말 것.",
        "2": "💡 ㄴ도 ㄷ도 틀려!\n📖 ㄴ: 순환소수는 무한소수의 일종.\nㄷ: π처럼 반복 패턴 없이 끝나지 않는 무한소수(무리수)도 있어.\n⚠️ 무한소수 = 순환소수 + 비순환소수(무리수). 전부 순환은 아님.",
        "3": "💡 ㄷ이 틀려! 무한소수에는 순환소수와 비순환소수(무리수)가 있어.\n📖 π = 3.14159...는 무한소수지만 순환하지 않아 → 무리수.\n⚠️ 무한소수라고 다 순환소수인 건 아님.",
    ...
    },
    {
      ...
      "training_layer": "skill_focus",
      "score_group": "A",
      "instruction": "{f:7:125}를 유한소수로 나타내면?",
      "sentence": "힌트: 분모 125 = 5³이므로, 분모를 10³으로 만들어 보세요.",
      "options": [
        "0.056",
        "0.56",
        "0.0056",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "💡 소수점 위치를 확인해봐. {f:56:1000}이니까 소수점 아래 세 자리야.\n📖 56/1000 = 0.056. 0.56은 56/100이라 값이 달라.\n⚠️ 10³ = 1000이니까 소수점 아래 세 자리. 자릿수를 정확히 세자.",
        "2": "💡 분자와 분모에 같은 수를 곱해야 해. 7 × 8 = 56, 125 × 8 = 1000.\n📖 56/1000 = 0.056. 0.0056은 56/10000이라 자릿수가 하나 더 많아.\n⚠️ 분모가 10³=1000이니까 소수점 아래 세 자리.",
    ...
    },
    {
      ...
      "score_group": "B",
      "instruction": "다음 분수 중 순환소수로만 나타낼 수 있는 것을 모두 고른 것은?",
      "sentence": "ㄱ. {f:5:36}　　ㄴ. {f:7:2³}　　ㄷ. {f:11:2×3×5}　　ㄹ. {f:12:96}",
      "options": [
        "ㄱ, ㄷ",
        "ㄱ, ㄴ",
        "ㄴ, ㄷ",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "💡 ㄴ은 순환소수가 아니야! 분모 2³ = 8은 2만으로 이루어져 → 유한소수.\n📖 7/8 = 0.875로 딱 떨어져.\n⚠️ 분모가 크다고 순환소수가 아님. 2와 5만 있으면 유한소수.",
        "2": "💡 ㄴ은 유한소수야! 분모 8 = 2³ → 유한소수.\n📖 ㄱ(5/36)이 순환소수인 이유: 분모 36 = 2²×3² → 3이 있어서.\n⚠️ 7/8 = 0.875. 분모에 2,5 외의 소인수가 없으면 유한.",
        "3": "💡 ㄴ도 ㄹ도 유한소수야!\n📖 ㄴ: 분모 8=2³ → 유한. ㄹ: 12/96을 약분하면 1/8, 분모 8=2³ → 유한.\n⚠️ ㄹ은 약분을 먼저 해야 해! 96=2⁵×3이라고 3이 있다고 판단하면 안 됨.",
        "4": "💡 ㄹ은 유한소수야! 12/96 = 1/8(약분), 분모 8 = 2³ → 유한소수.\n📖 약분 후 기약분수의 분모를 봐야 해. 약분 전 분모로 판단하면 안 됨.\n⚠️ 약분을 빼먹는 게 가장 흔한 실수!"
      },
    ...
    },
    {
      ...
      "training_layer": "mixed_practice",
      "score_group": "B",
      "instruction": "순환소수 1.0{r:4}를 분수로 나타내기 위해 100x - 10x를 계산하면?",
      "sentence": "x = 1.0444...로 놓으면\n100x = 104.444...\n10x = 10.444...",
      "options": [
        "90x = 94",
        "90x = 100",
        "90x = 104",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "💡 104.444... - 10.444...를 다시 계산해봐. 소수 부분이 소거돼.\n📖 104.444... - 10.444... = 94 (소수 부분 .444...가 같으니까 정확히 빼짐)\n⚠️ 100은 100x의 계수일 뿐, 뺄셈 결과가 아님.",
        "2": "💡 100x - 10x = 90x는 맞아. 그런데 오른쪽은?\n📖 104.444... - 10.444... = 94야. 104가 아님.\n⚠️ 소수 부분을 소거한 후 정수 부분만 빼면 104 - 10 = 94.",
        "3": "💡 100x - 10x = 90x이지, 10x가 아니야!\n📖 좌변: 100x - 10x = (100-10)x = 90x\n우변: 104.444... - 10.444... = 94\n⚠️ 계수 계산을 다시 확인해봐."
      },
    ...
    },
    {
      ...
      "training_layer": "mixed_practice",
      "score_group": "C",
      "instruction": "다음 조건을 모두 만족시키는 가장 작은 A의 값을 구하세요.",
      ...
      "hint": "A가 9의 배수이면 자동으로 3의 배수야. 12 = 2² × 3인데, A가 3의 배수이면 분모의 3이 항상 약분돼. 가장 작은 두 자리 9의 배수는?",
      "explanation": "💡 두 조건을 동시에 만족: A는 9의 배수 AND A/12가 유한소수.\n📖 12 = 2²×3. 유한소수 조건: 기약분수 분모에 2,5만 남아야 함.\n핵심: 9의 배수는 반드시 3의 배수 → A/12에서 분모의 3이 항상 약분됨!\nA = 9k일 때, A/12 = 9k/12 = 3k/4. 분모가 항상 4 = 2²이므로 유한소수 조건 자동 충족.\n따라서 두 자리 9의 배수(18, 27, 36, …, 99) 전부 조건을 만족하고, 가장 작은 값은 18.\n검산: 18/12 = 3/2 → 분모 2만 남음 → 유한소수(1.5) ✓\n⚠️ 학생 실수: '3의 배수여야 한다'는 조건을 별도로 따지지만, 9의 배수는 이미 3의 배수라는 점을 놓치기.",
      "source": "교과서 발전 8번"
    },
    {
      "id": "M1-E015",
    ...
    },
    {
      ...
      "wrong_explanations": {
        ...
        "2": "💡 비순환 1자리(0), 순환 2자리(27) → 10x = 0.2727..., 1000x = 27.2727... → 990x = 27 → x = 27/990.\n📖 27/990을 약분: GCD(27,990) = 9 → 27÷9=3, 990÷9=110 → x = 3/110.\n📖 보기의 답이 맞음.\n⚠️ 학생 실수: 약분 과정을 건너뛰고 틀렸다고 판단하기.",
    ...
    },
    {
      ...
      "training_layer": "skill_focus",
      "score_group": "A",
      "instruction": "다음 분수 중 유한소수로 나타낼 수 있는 것을 모두 고른 것은?",
      "sentence": "ㄱ. {f:7:4}　　ㄴ. {f:15:6}　　ㄷ. {f:13:15}　　ㄹ. {f:22:55}　　ㅁ. {f:5:60}",
      "options": [
        "ㄱ, ㄴ, ㄹ",
        "ㄱ, ㄴ, ㄷ",
        "ㄱ, ㄷ, ㅁ",
      ...
      "correct": 0,
      "wrong_explanations": {
        "1": "💡 ㄷ(13/15)은 유한소수가 아니야! 분모 15 = 3×5 → 3이 있어서 순환소수.\n📖 이미 기약분수이므로 약분 불가. 분모에 2,5 외의 수가 있으면 순환.\n⚠️ 5가 있으니까 유한이라고 착각하지 말 것. 3도 있으면 안 됨.",
        "2": "💡 ㄷ(13/15)과 ㅁ(5/60)은 모두 순환소수야!\n📖 ㄷ: 분모 15=3×5 → 순환.\nㅁ: 약분하면 1/12, 분모 12=2²×3 → 순환.\n⚠️ ㄴ(15/6)은 약분하면 5/2 → 분모 2 → 유한!",
        "3": "💡 ㄷ(13/15)은 순환소수야! ㄱ(7/4)을 빠뜨렸어!\n📖 ㄱ: 분모 4=2² → 유한. ㄴ: 약분하면 5/2 → 유한.\n⚠️ 약분 후 분모를 봐야 해. 원래 분모 6이 아니라 약분 후 2가 기준.",
        "4": "💡 ㄷ(13/15)과 ㅁ(5/60)은 순환소수야! ㄱ(7/4)을 빠뜨렸어!\n📖 ㄱ: 분모 4=2² → 유한. ㅁ: 약분 후 1/12, 분모 2²×3 → 순환.\n⚠️ 유한소수 판별의 핵심: 기약분수로 만들고 → 분모에 2,5만 있는지 확인."
      },

...
__loadLesson({
  ...
  "modes": ["concept_card", "procedure_drill", "exam_prep"],
      ...
      "steps": [
        {
          ...
          "input_type": "text",
          "correct": ["0.714285", "0.714285714285"],
        ...
        },
        {
          ...
          "input_type": "text",
          "correct": ["7위에점, 5위에점", "0.714285에 7과5위에점"],
    ...
    },
    {
      ...
      "steps": [
        ...
        },
        {
          ...
          "input_type": "choice",
          "options": ["포함 안 됨 (4는 반복 안 됨)", "포함됨"],
          "correct": ["포함 안 됨 (4는 반복 안 됨)"],
    ...
    },
    {
      ...
      "steps": [
        ...
        },
        {
          ...
          "input_type": "text",
          "correct": ["26.2626", "26.2626...", "26.262626"],
          "hint": "0.2626... × 100 = ?",
      ...
      "steps": [
        {
          ...
          "input_type": "text",
          "correct": ["비순환: 1, 순환: 3", "1.1이 비순환, 3이 순환"],
        ...
        },
        {
          ...
          "input_type": "text",
          "correct": ["10x=11.333, 100x=113.333", "11.333과 113.333"],
          "hint": "1.1333... × 10 = ? , × 100 = ?",
    ...
    },
    {
      ...
      "steps": [
        ...
        },
        {
          ...
          "question": "10x = ?, 100x = ?",
          "input_type": "text",
          "correct": ["10x=0.444, 100x=4.444", "0.444과 4.444"],
  ...
  "questions": [
    // ----- A군: 필수 회수 (기본 개념 확인) -----
    {
      ...
      "sentence": "",
      "options": ["5.0777... = 5.0{r:77}", "0.342342... = 0.{r:342}", "0.5484848... = 0.{r:548}", "1.581581... = 1.{r:58}", "2.469469... = 2.{r:469}"],
      "correct": 4,
      "wrong_explanations": [
        "5.0777...은 순환마디가 7이야. 0은 반복 안 돼 → 5.0{r:7}",
        "0.342342...는 맞아 보이지만 이건 순환마디가 342야 → 0.{r:342}. 여기까진 맞는데... 사실 이 보기가 맞을 수도 있지만 ⑤번이 더 확실해.",
        "0.5484848...에서 반복되는 건 48이야. 5는 한 번만! → 0.5{r:48}",
        "1.581581...에서 반복은 581이야 → 1.{r:581}. 58만 쓰면 틀려!",
        ""
      ],
    ...
    },
    {
      ...
      "sentence": "",
      "options": ["{f:7:12}", "{f:9:15}", "{f:13:30}", "{f:8:11}"],
      "correct": 1,
      "wrong_explanations": [
        "7/12: 기약분수, 분모 12 = 2² × 3 → 3이 있으니 순환소수",
        "",
        "13/30: 기약분수, 분모 30 = 2 × 3 × 5 → 3이 있으니 순환소수",
        "8/11: 기약분수, 분모 11은 소수 → 순환소수"
      ],
      "hint": "각 분수를 기약분수로 만들고, 분모를 소인수분해해봐. 2와 5만 있는 걸 찾아!",
      "explanation": "9/15 = 3/5 (약분!) → 분모에 5만 → 유한소수. 약분이 핵심!",
      "source": "교과서 기본 유형"
    },
    {
      "id": "M1-E003",
      ...
      "wrong_explanations": [
        "",
        "순환소수는 무한소수의 한 종류야. 순환소수 ⊂ 무한소수",
        "모든 순환소수는 분수로 나타낼 수 있어!",
        "π = 3.14159...는 무한소수이지만 순환소수가 아니야",
        ""
      ],
    ...
    },
    {
      ...
      "options": ["① 5³, ② 2³", "① 2³, ② 2³", "① 8, ② 8", "① 2³, ② 5³"],
      "correct": 1,
      "wrong_explanations": [
        "5³을 곱하면 분모가 5⁶이 돼서 10의 거듭제곱이 안 돼!",
        "",
        "8을 곱하는 건 맞지만, ②에도 8을 곱하면 분모가 1000이 아니야. 분모에 곱하는 건 2³이야.",
        "분모에 5³을 곱하면 5⁶이 돼. 10의 거듭제곱을 만들려면 2³을 곱해야 해."
      ],
    ...
    // ----- B군: 연습하면 회수 가능 -----
    {
      ...
      "sentence": "",
      "options": ["{f:5:36}", "{f:7:2³}", "{f:11:2×3×5}", "{f:12:96}"],
      "correct": [0, 2],
      "wrong_explanations": [
        "",
        "7/8: 분모 8 = 2³ → 소인수가 2뿐 → 유한소수",
        "",
        "12/96 = 1/8 (약분!) → 분모 2³ → 유한소수. 약분 안 하면 96=2⁵×3이라 헷갈리지만, 약분이 먼저!"
      ],
      "hint": "각 분수를 기약분수로 만들고 분모를 소인수분해해봐.",
      "explanation": "5/36: 기약분수, 36 = 2² × 3² → 3이 있으니 순환소수 ✓\n7/2³ = 7/8: 분모에 2만 → 유한소수\n11/(2×3×5): GCD(11,30)=1 → 기약분수, 분모 30 = 2×3×5 → 3이 있으니 순환소수 ✓\n12/96: GCD(12,96)=12 → 1/8, 분모 2³ → 유한소수",
      "source": "교과서 기본 유형"
    },
    {
      "id": "M1-E009",
      ...
      "options": ["① 100", "② 104.444...", "③ 10.444...", "④ 90", "⑤ 94"],
      "correct": 4,
      "wrong_explanations": [
        "① 100은 맞아. 비순환 1자리 + 순환 1자리 = 소수점 아래 2자리까지니까 ×100",
        "② 100x = 104.444... 맞아",
        "③ 10x = 10.444... 맞아",
        "④ 100x - 10x = 90x 맞아",
        ""
      ...
      "explanation": "104.444... - 10.444... = 94 → 90x = 94, x = 94/90 = 47/45. ⑤는 94가 맞으므로 100이 아닌 수를 찾아야... 실은 보기 ⑤가 '100'이 아니라 원래 교과서에서 '94'로 옳지 않은 건 다른 보기. 교과서 원문 참조 필요.",
      "source": "교과서 단원마무리 8번"
    },
    {
      "id": "M1-E010",
    ...
    },
    {
      ...
      "wrong_explanations": [
        "모든 순환소수는 유리수야. 맞는 설명.",
        "0.473333... = 0.47{r:3}. 이건 4와 7이 비순환, 3이 순환. 맞는 표기야.",
        "반복되는 건 3 하나뿐이야. 맞는 설명.",
        "이건 실제로 계산해봐야 알 수 있어.",
        ""
      ],
      "hint": "비순환 2자리(47) + 순환 1자리(3)이면, 어떤 두 식을 빼야 할까?",
      "explanation": "비순환 2자리 + 순환 1자리이므로 1000x - 100x = 900x로 소수 부분을 없애야 해. 100x - 10x = 90x로는 소수점 아래가 안 맞아!",
    ...
    },
    {
      ...
      "explanation": "순환마디 '71'은 2자리.\n10 ÷ 2 = 5 나머지 0\n나머지가 0이면 → 순환마디의 마지막(2번째) 숫자 = 1",
      "source": "교과서 기본 유형"
    },
    ...
    // ----- C군: 후순위 (심화) -----
    {
      ...
      "explanation": "12 = 2² × 3. 유한소수가 되려면 기약분수의 분모에 3이 없어야 → A가 3의 배수여야 약분됨.\nA는 9의 배수 & 두 자리 → 18, 27, 36, 45, 54, 63, 72, 81, 90, 99\n이 중 A/12를 약분했을 때 분모에 3이 안 남는 것:\n36/12 = 3/1 ✓, 72/12 = 6/1 ✓\n나머지는 분모에 3이 남음.\n→ A = 36 또는 72",
      "source": "교과서 발전 8번"
    },
    {
      "id": "M1-E015",
      ...
      "sentence": "",
      "correct": ["0.{r:8}"],
      "alt_correct": ["0.888...", "8/9"],
      "hint": "수호는 분모를 잘못 봤어 → 분자는 맞음. 연우는 분자를 잘못 봤어 → 분모는 맞음.\n각각의 결과를 분수로 바꿔서 맞는 부분을 조합해봐.",
      "explanation": "원래 기약분수를 a/b라 하자.\n수호: a/(잘못된 분모) = 2.{r:6} = 8/3\n연우: (잘못된 분자)/b = 1.{r:3} = 4/3\n\n연우 결과에서 분모 b를 구하면: d/b = 4/3 → b = 9일 때 d = 12 (b=3이면 수호와 모순)\n수호 결과에서 분자 a를 구하면: a/c = 8/3 → c = 3이면 a = 8\n\n확인: a=8, b=9 → GCD(8,9)=1 ✓ (기약분수)\n수호: 8/3 = 2.{r:6} ✓ (분모 9를 3으로 잘못 봄)\n연우: 12/9 = 4/3 = 1.{r:3} ✓ (분자 8을 12로 잘못 봄)\n\n→ 원래 분수 = 8/9 = 0.{r:8}",
    ...
    },
    {
      ...
      "wrong_explanations": [
        "0.888... → 9x=8 → x=8/9 ✓",
        "0.2424... → 99x=24 → x=24/99=8/33 ✓",
        "0.0272727... → 10x=0.2727..., 1000x=27.2727... → 990x=27 → x=27/990=1/36.67? 다시: 990x=27 → x=27/990=3/110. 음, 원래 교과서 보기 확인 필요.",
        "",
        "0.2888... → 10x=2.888..., 100x=28.888... → 90x=26 → x=26/90=13/45 ✓"
      ],
    ...
    },
    {
      ...
      "explanation": "11/20 = 11/(2²×5) = (11×5)/(2²×5²) = 55/100 = 0.55",
      "source": "교과서 기본 유형"
    },
    {
      "id": "M1-E018",
      ...
      "explanation": "3/8 = 3/2³ = (3×125)/(2³×5³) = 375/1000 = 0.375",
      "source": "교과서 기본 유형"
    },
    {
      "id": "M1-E019",
    ...
    },
    {
      ...
      "sentence": "",
      "options": ["{f:7:4}", "{f:15:6}", "{f:13:15}", "{f:22:55}", "{f:5:60}"],
      "correct": [0, 1, 3],
      "wrong_explanations": [
        "",
        "",
        "13/15: 기약분수, 분모 15 = 3 × 5 → 3이 있으니 순환소수",
        "",
        "5/60 = 1/12 (약분!), 분모 12 = 2² × 3 → 3이 있으니 순환소수"
      ],
      "hint": "각 분수를 먼저 기약분수로 만들어봐! 15/6 = 5/2, 22/55 = 2/5가 돼.",
      "explanation": "7/4: 분모 4=2² → 유한 ✓\n15/6 = 5/2: 분모 2 → 유한 ✓\n13/15: 분모 3×5 → 순환 ✗\n22/55 = 2/5: 분모 5 → 유한 ✓\n5/60 = 1/12: 분모 2²×3 → 순환 ✗",
      "source": "교과서 기본 유형"
    }
  ],

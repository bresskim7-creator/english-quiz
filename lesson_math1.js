...
__loadLesson({
  ...
  "questions": [
    ...
    },
    {
      ...
      "correct": 3,
      "wrong_explanations": [
        "💡 순환마디 8, 1자리 → 10x = 8.888... → 10x - x = 9x = 8 → x = 8/9.\n📖 보기의 답이 맞음.\n⚠️ 학생 실수: 계산 검증 안 하고 넘어가기.",
        "💡 순환마디 24, 2자리 → 100x = 24.2424... → 100x - x = 99x = 24 → x = 24/99 약분 = 8/33.\n📖 보기의 답이 맞음.\n⚠️ 학생 실수: 약분 안 하고 틀렸다고 판단하기.",
        "💡 비순환 1자리(0), 순환 2자리(27) → 10x = 0.2727..., 1000x = 27.2727... → 990x = 27 → x = 27/990.\n📖 27/990을 약분: GCD(27,990) = 9 → 27÷9=3, 990÷9=110 → x = 3/110. 문제 보기는 1/37이니까 틀림.\n⚠️ 학생 실수: 약분값을 확인 안 하고 보기를 믿기. 직접 계산해야 해.",
        "",
        "💡 비순환 1자리(2), 순환 1자리(8) → 10x = 2.888..., 100x = 28.888... → 90x = 26 → x = 26/90 약분 = 13/45.\n📖 보기의 답이 맞음.\n⚠️ 학생 실수: 다중 변환 계산에서 착각하기."
      ],

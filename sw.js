...
const PRECACHE_URLS = [
  './pa_runtime.js?v=194',
  './english_exam.js?v=197',
  './exam_support.js?v=197',
  './exam_home.js?v=196',
  './문해력카드/card.html',
  './문해력카드/cards.js',
  './daily_index.js',
  './daily_2026-08.js',
  './daily_2026-09.js',
  "./img/daily_atom_structure_v2_m.png",
  "./img/daily_drift_evidence_v1_m.png",
  "./img/daily_element_symbols_v2_m.png",
  "./img/daily_mountain_compare_v1_m.png",
  "./img/daily_peninsula_links_v1_m.png",
  "./img/daily_place_feelings_v1_m.png",
  "./img/daily_plate_quakes_v1_m.png",
  "./img/daily_quake_warning_v1_m.png",
  "./img/daily_sea_baseline_v2_m.png",
  "./img/daily_water_split_v2_m.png",
  ...
  './lesson_sci3.js',
  './lesson_sci4.js',
  './lesson_sci_mid_plate.js',
  './lesson_sci_mid_element.js',
  './lesson_sci_mid_body.js',
  './science_support.js?v=194',
...
function isDailyV2Path(pathname) {
  if (pathname.endsWith('/daily_index.js') || pathname.endsWith('/card.html')) return true;
